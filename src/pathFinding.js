function aStar(start, end, algorithm, heuristic) {
    ...
    while (openList.length > 0 && loopCount < maxLoopCount) {
        ...
        if (currentNode.isEqual(endNode)) {
            ...
            console.log("Algorithm Used");
            console.log(algorithm);
            console.log("Number of visited blocks");
            console.log(visitedNo - 5);
            console.log("Length of Path");
            console.log(path.length);
            console.log("Total Time taken for this maze");
            console.log(millis() - starttime + "ms");
            return {
                path: path.reverse(),
